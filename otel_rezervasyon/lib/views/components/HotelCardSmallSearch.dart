...
class HotelCardSmallSearch extends StatelessWidget {
  MainPageController mpc = Get.find();
  Otel otel;
  HotelCardSmallSearch(this.otel);
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        '${otel.fiyat! * mpc.checkOut.value.difference(mpc.checkIn.value).inDays}₺ toplam fiyat')
                  ],
                ),
              ),
              Container(
